	...
	function alchemists_register_required_plugins() {
		...
		$plugins = array(
			...
			array(
				...
				'source'       => 'http://dan-fisher.com/tf/alchemists-wp/downloads/jtPQnhHj/advanced-custom-fields-pro.zip',
				'required'     => true,
				'version'      => '5.6.9'
			),
			array(
				...
				'slug'         => 'js_composer',
				'source'       => 'http://dan-fisher.com/tf/alchemists-wp/downloads/jtPQnhHj/js_composer.zip',
				'required'     => true,
				'version'      => '5.4.7'
			),
			array(
