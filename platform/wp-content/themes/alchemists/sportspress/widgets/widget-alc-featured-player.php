...
class Alchemists_Widget_Featured_Player extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		sp_get_template( 'player-featured.php', array( 'id' => $id, 'title' => $title, 'caption' => $caption, 'style_type' => $style_type, 'stat_type' => $stat_type, 'columns' => $columns, 'performance' => $performance, 'add_link' => $add_link ) );
	...
	function form( $instance ) {
		...
		$instance             = wp_parse_args( (array) $instance, array( 'title' => '', 'id' => null, 'team' =>'', 'style_type' => '', 'stat_type' => '', 'caption' => '', 'columns' => null, 'performance' => null, 'add_link' => '' ) );
