	...
	function form( $instance ) {
		...
		<p>
			...
			<select id="<?php echo esc_attr( $this->get_field_id( 'layout_style' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'layout_style' ) ); ?>" class="widefat">
				<option value="default" <?php echo ( 'default' == $instance['layout_style'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'Layout 1', 'alchemists' ); ?></option>
				<option value="alt" <?php echo ( 'alt' == $instance['layout_style'] ) ? 'selected="selected"' : ''; ?>><?php esc_html_e( 'Layout 2', 'alchemists' ); ?></option>
			</select>
		</p>
