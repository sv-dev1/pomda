...
<div class="container-fluid token" id="particles-js">
  <div class="container zindex">
    <div class="row">
        ...
        <div class="row">
          <div class="col-md-6 col-xs-12">
            <div class="left_left  full_left">
              ...
              <ul class="big_btnn">
                <li><button class="pop" type="button" data-toggle="modal" data-target="#myModal">Ethereum</button>
                </li>
                <li class="sec_btn"><button type="button" data-toggle="modal" data-target="#myModalbitcoin">Bitcoin</button></li>
              </ul>
             <!--  <ul class="small_btnn">
			  ...
			  <div class="contract-info1"><span>KICK Smart Contract Address</span>
          <i class="fa fa-info"  data-toggle="modal" data-target="#myModal1"></i></div>
            </div>
      ...
      <div class="row">
        <div class="col-md-9 col-xs-12">
          <div class="left_eight full_left1">
            <h1>History</h1>
            <p>Here you transaction history will be shown</p>
          </div>
        </div>
        <div class="col-md-3 col-xs-12 pad">
          <div class="right_four1">
            <h2 class="personal-header1"><span>Bounty</span><i class="fa fa-info"></i></h2>
			<div class="personal-text"><span>Share this link and get 10% of payments of your referrals</span></div>
			<form><div class="input1"><input type="text" placeholder="https://eo.trade?r_id=932550248"></div><button class="button blue mid" type="button"><span>Copy</span></button></form>
          </div>
        </div>
      </div>
